...
import 'package:login_ui_design/drawer.dart';
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: new Color(0xFFFF8A65),
            gradient: LinearGradient(
              colors: [(new Color(0xFFFF8A65)), new Color(0xFFF4511E)],
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                  colors: [(new Color(0xFFFF8A65)), new Color(0xFFFF8A65)],
